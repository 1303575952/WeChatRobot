package com.sxu.wechat.config;

import java.util.Arrays;
import java.util.List;

import com.sxu.wechat.util.PropertyReader;

public class Constant {

	// 特殊用户 须过滤
	public static final List<String> FILTER_USERS = Arrays.asList("newsapp", "fmessage", "filehelper", "weibo",
			...
			"blogappweixin", "weixin", "brandsessionholder", "weixinreminder", "wxid_novlwrv3lqwv11", "gh_22b87fa7cb3c",
	...
	public static final String[] SYNC_HOST = { "webpush.weixin.qq.com", "webpush2.weixin.qq.com", "webpush.wechat.com",
